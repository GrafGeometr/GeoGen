...
{
    /// <summary>
    /// The <see cref="IObjectConstructor"/> for <see cref="PredefinedConstructionType.CenterOfNegativeHomothety"/>>.
    /// </summary>
    public class CenterOfNegativeHomothetyConstructor : PredefinedConstructorBase
    {
        #region Constructor
        ...
        public CenterOfNegativeHomothetyConstructor(IConstructorFailureTracer tracer)
            : base(tracer)
        {
        }
